...
public class Download {
	...
	public static void study(Study study, File tmpDir, Format format, Boolean preferMultiframe) throws Exception {
		for (Series series : study.series) {
			//if ("MR".equals(series.modality)) {
			if (Dicom.downloadable(series)) {
				series(series, tmpDir, format, preferMultiframe);
			}
		}
	}

	public static void series(Series series, File tmpDir, Format format, boolean preferMultiframe) throws Exception {
